...
func (screen GameOverScreen) Update(ctx *canvas.Context2D) {

}

// Draw handles drawing for the game over screen.
func (screen GameOverScreen) Draw(ctx *canvas.Context2D) {
	ctx.FillStyle = "black"
	ctx.Font = "48px serif"
...
func (screen GameOverScreen) KeyPressed(keyCode int, pressed bool) {
