...
func (screen SettingsScreen) Update(ctx *canvas.Context2D) {

}

// Draw draws objects on the settings screen.
func (screen SettingsScreen) Draw(ctx *canvas.Context2D) {
	ctx.FillStyle = "black"
	ctx.Font = "48px serif"
...
func (screen SettingsScreen) KeyPressed(keyCode int, pressed bool) {
